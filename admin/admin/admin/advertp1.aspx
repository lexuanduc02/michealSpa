<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="advertp1.aspx.vb" Inherits="admin.advertp1" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Quản lý tiện ích dự án</title>
...
<tr>
    <td class="main-content-right">
        ...
        <table id="tblView" runat="server" visible="false" style="width:100%;" cellpadding="0" cellspacing="0">
            <tr style="background-color:#3C8DBC;">
                <td style="height:35px; padding-left:5px;">
                    ...
                    <asp:DropDownList CssClass="textbox drl" ID="drlSubID" Visible="false" runat="server" DataValueField="ID" DataTextField="Name" Width="80%" AutoPostBack="true"  />
                    <asp:DropDownList CssClass="textbox drl" ID="drlType1" Visible="false" runat="server" AutoPostBack="true">
                        <asp:ListItem Value="98" Text="Home Slider (Full HD)" />
                    </asp:DropDownList>
                </td>
        ...
        <table id="tblAdd" runat="server" visible="false" style="width:100%;" cellpadding="0" cellspacing="1">
            ...
            <tr>
                <td class="td1"><div style="width:95px;">Tiêu đề:</div></td>
                <td class="td2">
            ...
            <tr style="display:none;">
                ...
                <td class="td2">
                    <asp:DropDownList CssClass="textbox drl" ID="drlType" Visible="false" runat="server">
                        <asp:ListItem Value="98" Text="Home Slider (Full HD)" ></asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
