<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="city.aspx.vb" Inherits="admin.city" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Tỉnh thành/quận huyện</title>
                ...
                <asp:DataGrid id="dtgrView" DataKeyField="ID" runat="server"  CssClass="table table-striped table-bordered" AutoGenerateColumns="False" AllowSorting="True" BorderStyle="None" cellpadding="3" Width="100%" HorizontalAlign="Center" AllowPaging="True"> 
                     ...
                     <Columns>    
                        ...
                        <asp:TemplateColumn HeaderText="Published" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center"> 
                         ...
                         <asp:TemplateColumn HeaderText="District" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="150px" > 
                            <ItemTemplate>
                                <a data-fancybox data-type="iframe" data-src="districts.aspx?id=<%#Eval("ID") %>" class="button btnBlue"  href="javascript:;" >Thêm quận huyện</a>
                            </ItemTemplate> 
                        </asp:TemplateColumn>
