Public Class advertp1
    ...
    Private Sub BindData()
        ...
        lblLink.Text = "Quản lý tiện ích dự án:<b style=color:red;text-transform:uppercase>" & drlSubID.SelectedItem.Text & "</b>"
        Call LoadAdvert()
    End Sub
    ...
    Private Sub LoadAdvert()
        ...
        strSQL = "select ID,Name,Title,Case When right(Img,3)='swf' Then '<script>flash(" & """" & "/images/media/duan/'+Img+'" & """" & ",50,100);</script>' Else '<img src=/images/media/duan/'+Img+' style=width:100px;height:50px; />' End Img,Ac,Sort from tblAdvertP where ProID=" & drlSubID.SelectedValue & " and Type = 2 order by Sort ASC"
    ...
    Private Sub btnUpdate1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate1.Click, btnUpdate2.Click
        ...
        For i = 0 To dtgrView.Items.Count - 1
            ...
            strSQL = "update tblAdvertP set Title=N'" & qtyTitle.Text & "',Sort='" & IIf(qtySort.Text = "", "00", qtySort.Text) & "',Ac=" & qtyAc.SelectedValue & " where ID=" & Val(dtgrView.DataKeys(i))
    ...
    Private Sub btnAddU1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddU1.Click, btnAddU2.Click
        ...
        f.Add("Type,0,1,4") : v.Add(2) 'Vùng Hiển thị - Kiểu Int có độ rộng là 4
        ...
        Response.Redirect("advertp1.aspx?id=" & drlSubID.SelectedValue)
    End Sub
