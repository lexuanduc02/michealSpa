...
<script runat="server">
    ...
    public override bool CheckAuthentication()
    {
        ...
        //return true;
        return (Session["IsAuthorizeds"] != null && (bool)Session["IsAuthorizeds"] == true);
    }
    ...
    public override void SetConfig()
    {
        ...
        LicenseName = "HAI TRIEU";
        LicenseKey = "FHD2GG6BWT72FU21GGSDTYN7S8CJ66VD";
        ...
        RoleSessionVar = "CKFinder_Permission";
        ...
        acl2.FileRename = false;
        acl2.FileDelete = false;
